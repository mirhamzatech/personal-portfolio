    ...
    >
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <div className="font-pacifico text-2xl text-navy-deep dark:text-navy-deep hover:text-primary-blue transition-colors cursor-pointer">
            <a href="#">Hamza</a>
          </div>
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 ${
                    isActive
                      ...
                      : "text-navy-deep dark:text-navy-deep hover:text-primary-blue hover:bg-gray-50 dark:hover:bg-gray-800"
                  }`}
                >
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              {isMenuOpen ? (
                <X className="w-5 h-5 text-navy-deep dark:text-navy-deep" />
              ) : (
                <Menu className="w-5 h-5 text-navy-deep dark:text-navy-deep" />
              )}
            </button>
          </div>
        </div>
                ...
                <button
                  ...
                  className={`text-left transition-colors ${
                    activeSection === item.href.replace("#", "")
                      ? "text-primary-blue"
                      : "text-navy-deep dark:text-navy-deep hover:text-primary-blue"
                  }`}
                >
                  {item.name}
                </button>
